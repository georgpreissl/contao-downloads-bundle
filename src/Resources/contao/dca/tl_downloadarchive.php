...
class tl_downloadarchive extends Backend
{
	...
	public function copyArchive($row, $href, $label, $title, $icon, $attributes)
	{
		...
		return ($this->User->isAdmin || $this->User->hasAccess('create', 'downloadarchivep')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>image</a> ' : 'image ';
	}
	...
	public function deleteArchive($row, $href, $label, $title, $icon, $attributes)
	{
		...
		return ($this->User->isAdmin || $this->User->hasAccess('delete', 'downloadarchivep')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>image</a> ' : 'image ';
	}
}
