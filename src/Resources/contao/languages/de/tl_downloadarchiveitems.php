...
$GLOBALS['TL_LANG']['tl_downloadarchiveitems']['createImage'] = array('Vorschaubild automatisch erstellen', 'Wenn Sie diese Option wählen, wird anstatt des Icons ein Vorschaubild generiert. Nur möglich bei den Dateiformaten jpg, png und gif.');
...
$GLOBALS['TL_LANG']['tl_downloadarchiveitems']['addImage']     = array('Vorschaubild auswählen', 'Wenn Sie diese Option wählen, können Sie ein Vorschaubild für den Download auswählen.');
...
$GLOBALS['TL_LANG']['tl_downloadarchiveitems']['image_legend']      = 'Vorschaubild auswählen';
